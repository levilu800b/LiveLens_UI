    ...
    const loadAnimation = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          resolution_width: animationData.resolution_width,
          resolution_height: animationData.resolution_height,
          animation_software: animationData.animation_software || '',
          render_engine: animationData.render_engine || '',
          production_time: animationData.production_time,
          ...
          language: animationData.language,
