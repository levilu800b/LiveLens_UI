        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 max-w-5xl mx-auto">
          ...
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">Backend Sync Status</h3>
                <div className="mt-2 text-sm text-blue-700">
                  <p>Currently synced: Title, Description, Short Description, Category, Duration, Video Quality, Content Rating, Release Date, SEO fields, Media files, and Settings.</p>
                  <p className="mt-1">Form fields like Summary, Upcoming Content details, and Content Type are displayed for future compatibility but may not be saved to the backend yet.</p>
                </div>
              </div>
            </div>
          </div>
